...
function demon_detect_callback(isDetected) {
  if (isDetected) {
...
function demon_init_threeScene(spec) {
  const threeStuffs = JeelizThreeHelper.init(spec, demon_detect_callback);
  ...
  */
  ...
  loaderAngelIntro.load(
    './facefilter/filters/angel/models/angel/angel_intro.json',
    function (geometry) {
      const mat = new THREE.MeshBasicMaterial({
        map: new THREE.TextureLoader().load("./facefilter/filters/angel/models/angel/diffuse_angel.png"),
        morphTargets: true
      });
  ...
  loaderAngelIdle.load(
    './facefilter/filters/angel/models/angel/angel_idle.json',
    function (geometry) {
      const mat = new THREE.MeshBasicMaterial({
        map: new THREE.TextureLoader().load("./facefilter/filters/angel/models/angel/diffuse_angel.png"),
        morphTargets: true
  ...
  loaderAngelFight.load(
    './facefilter/filters/angel/models/angel/angel_fight.json',
    function (geometry) {
      const mat = new THREE.MeshBasicMaterial({
        map: new THREE.TextureLoader().load("./facefilter/filters/angel/models/angel/diffuse_angel.png"),
        morphTargets: true
  ...
  */
  ...
  loaderHarpIntro.load(
    './facefilter/filters/angel/models/angel/harp_intro.json',
    function (geometry) {
      const mat = new THREE.MeshBasicMaterial({
        map: new THREE.TextureLoader().load("./facefilter/filters/angel/models/angel/harpe.jpg"),
        morphTargets: true
      });
  ...
  loaderHarpIdle.load(
    './facefilter/filters/angel/models/angel/harp_idle.json',
    function (geometry) {
      const mat = new THREE.MeshBasicMaterial({
        map: new THREE.TextureLoader().load("./facefilter/filters/angel/models/angel/harpe.jpg"),
        morphTargets: true
  ...
  loaderHarpFight.load(
    './facefilter/filters/angel/models/angel/harp_fight.json',
    function (geometry) {
      const mat = new THREE.MeshBasicMaterial({
        map: new THREE.TextureLoader().load("./facefilter/filters/angel/models/angel/harpe.jpg"),
        morphTargets: true
  ...
  */
  ...
  loaderDemonIntro.load(
    './facefilter/filters/angel/models/demon/demon_intro.json',
    function (geometry) {
      const mat = new THREE.MeshBasicMaterial({
        map: new THREE.TextureLoader().load("./facefilter/filters/angel/models/demon/diffuse_demon.png"),
        morphTargets: true
      });
  ...
  loaderDemonIdle.load(
    './facefilter/filters/angel/models/demon/demon_idle.json',
    function (geometry) {
      const mat = new THREE.MeshBasicMaterial({
        map: new THREE.TextureLoader().load("./facefilter/filters/angel/models/demon/diffuse_demon.png"),
        morphTargets: true
  ...
  loaderDemonFight.load(
    './facefilter/filters/angel/models/demon/demon_fight.json',
    function (geometry) {
      const mat = new THREE.MeshBasicMaterial({
        map: new THREE.TextureLoader().load("./facefilter/filters/angel/models/demon/diffuse_demon.png"),
        morphTargets: true
  ...
  */
  ...
  loaderForkIntro.load(
    './facefilter/filters/angel/models/demon/fourche_intro.json',
    function (geometry) {
      const mat = new THREE.MeshBasicMaterial({
        map: new THREE.TextureLoader().load("./facefilter/filters/angel/models/demon/fourche.jpg"),
        morphTargets: true
      });
  ...
  loaderForkIdle.load(
    './facefilter/filters/angel/models/demon/fourche_idle.json',
    function (geometry) {
      const mat = new THREE.MeshBasicMaterial({
        map: new THREE.TextureLoader().load("./facefilter/filters/angel/models/demon/fourche.jpg"),
        morphTargets: true
  ...
  loaderForkFight.load(
    './facefilter/filters/angel/models/demon/fourche_fight.json',
    function (geometry) {
      const mat = new THREE.MeshBasicMaterial({
        map: new THREE.TextureLoader().load("./facefilter/filters/angel/models/demon/fourche.jpg"),
        morphTargets: true
  ...
  // CREATE THE MASK
  FACEMESH = JeelizThreeHelper.create_threejsOccluder('./facefilter/filters/angel/models/face/face.json');
...
function init_filter() {
  ...
  JeelizResizer.size_canvas({
    ...
    callback: function(isError, bestVideoSettings){
      init_demonfaceFilter(bestVideoSettings);
    }
  })
}

function init_demonfaceFilter(videoSettings) {
