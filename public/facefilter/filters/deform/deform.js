...
function foot_init_threeScene(spec){
  ...
  */
  maskLoader.load('./facefilter/filters/deform/models/faceLowPoly.json', function(maskBufferGeometry){
...
function init_filter() {
  JeelizResizer.size_canvas({
    ...
    callback: function(isError, bestVideoSettings){
      ...
      //bestVideoSettings['idealWidth'] = w;  //ideal video width in pixels
      //bestVideoSettings['idealHeight']= h; //ideal video height in pixels
      bestVideoSettings['facingMode']='user';
