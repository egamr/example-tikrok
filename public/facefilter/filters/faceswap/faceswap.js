...
function init_filter(){ // entry point
...
function start(errCode, bestVideoSettings){
  ...
  //bestVideoSettings['idealWidth'] = 640;  //ideal video width in pixels
  //bestVideoSettings['idealHeight']= 480; //ideal video height in pixels
